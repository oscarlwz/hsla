...
def get_webtable_info(filename, nfiles, counter):
    ...
    if os.path.exists(str(hdr0['targname']).strip()+'_coadd_G130M_final_all.fits.gz'): G130M_coadd_exists = True 
    if os.path.exists(str(hdr0['targname']).strip()+'_coadd_G160M_final_all.fits.gz'): G160M_coadd_exists = True 
    if os.path.exists(str(hdr0['targname']).strip()+'_coadd_G140L_final_all.fits.gz'): G140L_coadd_exists = True 
